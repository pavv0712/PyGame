...
enemy_x_pos = (screen_width / 2) - (enemy_width / 2) #캐릭터를 중앙에 화면 절반크기
enemy_y_pos = (screen_height/2) - (enemy_height/2) # 캐릭터를 중앙 가장 밑에 세로크기 가장 밑에
