    ...
    for ball_idx, ball_val in enumerate(balls):
            ...
            for weapon_idx, weapon_val in enumerate(weapons):
                ...
                if weapon_rect.colliderect(ball_rect):
                    ...
                    #작은 작은 크기의 공이 아니라면 다음 단계의 공으로 나눠주기
                ...
                continue #안쪽 for문 조건이 맞지 않으면 continue. 바깥쪽 for문 계속 수행
            break #안쪽 for문에서 break를 만나면 여기로 집입 가능. 2중 for문을 한번에 break
